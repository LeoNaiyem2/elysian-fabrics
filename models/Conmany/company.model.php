...
";
	...
	static function html_table($page = 1,$perpage = 10,$criteria="",$action=true){
		...
		while($company=$result->fetch_object()){
			...
			$html.="<tr><td>$company->id</td><td>$company->name</td><td>$company->mobile</td><td>$company->bin</td><td>$company->email</td><td>$company->website</td><td>$company->city</td><td>$company->area</td><td>$company->street_address</td><td>$company->post_code</td><td>$company->inactive</td><td>$company->logo</td> $action_buttons</tr>";
		}
		$html.="</table>";
	...
	static function html_row_details($id){
		...
		$html.="<tr><th>Logo</th><td>$company->logo</td></tr>";
