...
<div class="invoice p-3 mb-3">
  ...
  <div class="row">
    <div class="col-12">
      <h4>
        <img style="margin-top:-20px;" src='<?= $base_url ?>/img/<?= $company->logo ?>' width='100' />
    ...
    <div class="col-sm-4 invoice-col">
      ...
      <table>
        <tr>
          <td><b>Order ID:</b></td>
          <td>
            <form name="f"><input type="text" style="width:60px" id="order_id" name="order_id" /><input type="button"
                id="go" value="Go" onclick="printCart(document.f.order_id.value)" /></form>
          </td>
        </tr>
        <tr>
...
<script>
  ...
  let base_url_to = `http://naiyem.intelsofts.com/Projects/core/core_elysianFabrics`;
  let products = [];
  ...
  async function ProcessDelivery() {
    ...
    if (confirm("Are you sure?")) {
      ...
      try {
        ...
        window.location.href = `${base_url_to}/stock/balance`;
