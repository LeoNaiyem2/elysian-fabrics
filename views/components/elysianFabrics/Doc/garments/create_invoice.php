...
<div style="max-width:800px;margin:0 auto;" class="card mb-3">
    <div class="card-body">
        <div class="row align-items-center text-center mb-3">
            <div class="col-sm-6 text-sm-start">
                <img src='<?= $base_url ?>/img/<?= $company->logo ?>' width='150' />
            </div>
            <div class="col text-sm-end mt-3 mt-sm-0">
                <h2 class="mb-3">Invoice</h2>
                <h5><?= $company->name ?></h5>
                <p class="fs--1 mb-0"><?= $company->street_address ?><br /><?= $company->area ?>, <?= $company->city ?>
                </p>
            </div>
            <div class="col-12">
                <hr />
        ...
        <div class="row align-items-center">
            <div class="col">
                ...
                <p class="fs--1">
                    <a href="mailto:<?= $company->email ?>"><?= $company->email ?></a><br /><a
            ...
            <table class="table table-striped border-bottom">
                <thead class="light">
                    ...
                    <tr class="text-white dark__bg-1000">
                        ...
                        <th class="border-0 text-center"><input type="text" class="form-control" style="width:100%"
                                name="unit" id="unit" value="1" /></th>
                        <th class="border-0 text-end"><input type="text" class="form-control" style="width:100%"
                                name="price" id="price" /></th>
                        <th class="border-0 text-end"></th>
                        <th class="border-0 text-end"><input class="form-control" type="button" value=" + "
                                style="width:100%" name="btnAdd" id="btnAdd" /></th>
                    </tr>
                </thead>
                <tbody id="tbody">
        ...
        <div class="row justify-content-end">
            <div class="col-auto">
                <table class="table table-sm table-borderless fs--1 text-end">
                    ...
                    <tr>
                        <th colspan="5">
                            <input type="button" class="btn btn-primary" onclick="CreateInvoice()" name="btnProcess"
