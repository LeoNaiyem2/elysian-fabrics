...
<div class="invoice p-3 mb-3">
  ...
  <div class="row">
    <div class="col-12">
      <h4>
        <img style="margin-top:-30px;" src='<?= $base_url ?>/img/<?= $company->logo ?>' width='100' />
  ...
  <div class="row invoice-info">
    <div class="col-sm-4 invoice-col">
      ...
      <address>
        ...
        <?= $company->street_address ?>, <?= $company->city ?><br>
  ...
  <div class="row no-print">
    <div class="col-12">
      <a href="invoice-print.html" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i>
        Print</a>
      <button type="button" id="btnProcessOrder" class="btn btn-success float-right"><i class="far fa-credit-card"></i>
